...
export interface AgentAttributes {
    ...
    isActive?: boolean;     // ✅ Use isActive instead of "active"
...
// 2) Creation attributes (omit autogenerated/optional fields)
...
export class AgentModel
    ...
    public email!: string | null;  // ✅ Added
...
AgentModel.init(
    {
        ...
        status: {
            type: DataTypes.ENUM('on_duty', 'idle', 'off_duty'),
            defaultValue: 'idle',
        },
        lastSeenAt: {
            type: DataTypes.DATE,
...
export type CollectionStatus = 'pending' | 'completed' | 'cancelled' | 'collected' | 'allocated' | 'allotted';
...
CollectionModel.init(
    {
        ...
        status: {
            type: DataTypes.ENUM('pending', 'assigned', 'in_progress', 'completed', 'cancelled', 'collected', 'allotted', 'allocated'),
